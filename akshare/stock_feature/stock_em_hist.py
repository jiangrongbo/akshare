...
def stock_zh_a_hist(
        symbol: str = "000001",
        period: str = 'daily',start_date: str = "19700101",
...
if __name__ == "__main__":
    ...
    stock_hk_hist_min_em_df = stock_hk_hist_min_em(symbol="01611", period='1', adjust='', start_date="2021-09-01 09:32:00", end_date="2021-09-07 18:32:00")
    print(stock_hk_hist_min_em_df)
